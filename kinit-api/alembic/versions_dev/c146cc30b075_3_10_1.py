...
Revision ID: c146cc30b075
Revises: 
Create Date: 2026-03-22 15:41:49.578037
...
def upgrade():
    ...
    sa.Column('job_state', sa.LargeBinary(length=2147483647), nullable=False),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('scheduler_task_record',
    sa.Column('job_id', sa.String(length=191), nullable=False, comment='任务编号'),
    sa.Column('job_class', sa.String(length=512), nullable=True),
    sa.Column('name', sa.String(length=255), nullable=True),
    sa.Column('group', sa.String(length=255), nullable=True),
    sa.Column('exec_strategy', sa.String(length=32), nullable=True),
    sa.Column('expression', sa.String(length=512), nullable=True),
    ...
    op.create_index(op.f('ix_scheduler_task_record_job_id'), 'scheduler_task_record', ['job_id'], unique=False)
    op.create_index(op.f('ix_scheduler_task_record_name'), 'scheduler_task_record', ['name'], unique=False)
    ...
    sa.Column('telephone', sa.String(length=32), nullable=True, comment='手机号'),
    sa.Column('user_id', sa.Integer(), nullable=True, comment='用户ID'),
    sa.Column('user_name', sa.String(length=255), nullable=True, comment='用户名'),
    ...
    sa.Column('request_method', sa.String(length=16), nullable=True, comment='HTTP 方法'),
    sa.Column('api_path', sa.String(length=512), nullable=True, comment='路由 path'),
    sa.Column('system', sa.String(length=128), nullable=True, comment='操作系统'),
    ...
    sa.Column('route_name', sa.String(length=128), nullable=True, comment='路由 name'),
    ...
    sa.Column('content_length', sa.String(length=32), nullable=True, comment='Content-Length'),
    sa.Column('id', sa.Integer(), nullable=False, comment='主键ID'),
    sa.Column('create_datetime', sa.DateTime(), server_default=sa.text('now()'), nullable=False, comment='创建时间'),
    sa.Column('update_datetime', sa.DateTime(), server_default=sa.text('now()'), nullable=False, comment='更新时间'),
    sa.Column('delete_datetime', sa.DateTime(), nullable=True, comment='删除时间'),
    ...
    op.create_index(op.f('ix_vadmin_record_operation_summary'), 'vadmin_record_operation', ['summary'], unique=False)
    ...
    op.create_table('vadmin_system_task',
    sa.Column('task_id', sa.String(length=24), nullable=False, comment='任务编号'),
    ...
    sa.Column('exec_strategy', sa.String(length=32), nullable=False, comment='执行策略'),
    ...
    sa.Column('start_date', sa.String(length=32), nullable=True, comment='开始时间'),
    sa.Column('end_date', sa.String(length=32), nullable=True, comment='结束时间'),
    sa.Column('task_disabled', sa.Boolean(), nullable=False, comment='调度失败等标记'),
    sa.Column('create_datetime', sa.DateTime(), server_default=sa.text('now()'), nullable=False, comment='创建时间'),
    sa.Column('update_datetime', sa.DateTime(), server_default=sa.text('now()'), nullable=False, comment='更新时间'),
    sa.PrimaryKeyConstraint('task_id'),
    comment='定时任务定义（MySQL）'
    )
    op.create_index(op.f('ix_vadmin_system_task_group'), 'vadmin_system_task', ['group'], unique=False)
    op.create_table('vadmin_system_task_group',
    sa.Column('value', sa.String(length=255), nullable=False, comment='分组值'),
    sa.Column('id', sa.Integer(), nullable=False, comment='主键ID'),
    sa.Column('create_datetime', sa.DateTime(), server_default=sa.text('now()'), nullable=False, comment='创建时间'),
    sa.Column('update_datetime', sa.DateTime(), server_default=sa.text('now()'), nullable=False, comment='更新时间'),
    sa.Column('delete_datetime', sa.DateTime(), nullable=True, comment='删除时间'),
...
def downgrade():
    ...
    op.drop_index(op.f('ix_vadmin_system_task_group'), table_name='vadmin_system_task')
    ...
    op.drop_index(op.f('ix_vadmin_record_operation_summary'), table_name='vadmin_record_operation')
    ...
    op.drop_index(op.f('ix_scheduler_task_record_name'), table_name='scheduler_task_record')
    op.drop_index(op.f('ix_scheduler_task_record_job_id'), table_name='scheduler_task_record')
